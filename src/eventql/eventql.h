...
enum {
  ...
  EVQL_OP_META_DISCOVER                = 0x0204,
  EVQL_OP_META_DISCOVER_RESULT         = 0x0205,
  EVQL_OP_META_LISTPARTITIONS          = 0x0206,
  EVQL_OP_META_LISTPARTITIONS_RESULT   = 0x0207,
  EVQL_OP_META_FINDPARTITION           = 0x0208,
  EVQL_OP_META_FINDPARTITION_RESULT    = 0x0209
};
