...
select
    ...
    date_add(from_timestamp(1486913087), "01:10", "HOUR_MINUTE"),
    date_add(from_timestamp(1486913087), "01:10:10", "HOUR_SECOND"),
    date_add(from_timestamp(1486913087), "2 12:30:10", "DAY_SECOND"),
