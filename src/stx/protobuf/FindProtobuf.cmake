...
function(PROTOBUF_GENERATE_CPP SRCS HDRS)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      ARGS --cpp_out ${CMAKE_CURRENT_BINARY_DIR} --proto_path ${CMAKE_CURRENT_SOURCE_DIR} --proto_path ${PROTOBUF_INCLUDE_DIR} --proto_path ${FNORD_SOURCE_DIR}/stx ${PROTOC_ARGS} ${ABS_FIL}
      DEPENDS ${ABS_FIL}
