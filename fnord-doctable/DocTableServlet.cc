 ...
 */
#include "fnord-doctable/DocTableServlet.h"
#include "fnord-json/json.h"

namespace fnord {
namespace doctable {

DocTableServlet::DocTableServlet(TableRepository* tables) : tables_(tables) {}

void DocTableServlet::handleHTTPRequest(
...
void DocTableServlet::insertRecord(
...
void DocTableServlet::commitTable(
    http::HTTPRequest* req,
    http::HTTPResponse* res,
    URI* uri) {
  const auto& params = uri->queryParams();
...
void DocTableServlet::mergeTable(
    http::HTTPRequest* req,
    http::HTTPResponse* res,
    URI* uri) {
  const auto& params = uri->queryParams();
...
void DocTableServlet::tableInfo(
    http::HTTPRequest* req,
    http::HTTPResponse* res,
    URI* uri) {
  const auto& params = uri->queryParams();
...
void DocTableServlet::tableSnapshot(
    http::HTTPRequest* req,
    http::HTTPResponse* res,
    URI* uri) {
  const auto& params = uri->queryParams();
